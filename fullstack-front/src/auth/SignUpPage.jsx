        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {signUpStatus.message && (
            <div className={`p-4 mb-4 rounded-md ${
              signUpStatus.type === 'success' ? 'bg-green-100' : 'bg-red-100'
            }`}>
              <p className={`text-sm ${
                signUpStatus.type === 'success' ? 'text-green-800' : 'text-red-800'
              }`}>
                {signUpStatus.message}
              </p>
            </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium text-ggray-700">
                Username
              </label>
              <input
                type="text"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="font-medium text-indigo-600 hover:text-green-500">
                Sign in
              </Link>
            </p>
          </div>
